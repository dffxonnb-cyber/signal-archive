...
const decisionFiles: DecisionFile[] = [
  ...
  },
  {
    ...
    signal: "후보 선택 전에 확인해야 할 거래 둔화, 과밀, 보호 종료 임박, 연락 맥락 신호",
    criteria: "가격 부담, 유동성, 경쟁도, 수요 취약도, 보호 종료일, 연락 가능성",
    decisionOutput: "보류 사유, 대체 후보, 우선 확인 공고를 먼저 제시",
    evidence: ["Redveil 리스크 근거", "Shelter 보호 종료 신호", "서울 25개 구", "Neon/fallback PWA"],
