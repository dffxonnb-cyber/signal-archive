...
const reviewerPaths = [
  {
    ...
    title: "전체 적합성 빠르게 보기",
    summary: "전체 적합성을 빠르게 보려면 Redveil의 decision artifact를 먼저 확인한 뒤, public-data service와 SQL/guardrail workflow로 확장해 봅니다.",
    openFirst: [
      {
        title: "Redveil",
        href: "/projects/seoul-storefront-redveil",
      ...
      },
      {
        title: "DecisionOps Lab",
        href: "/projects/decisionops-lab",
        reason: "SQL mart, data quality gate, A/B evidence, guardrail decision memo 확인",
      },
      {
        title: "LH Traffic Safety",
        href: "/projects/lh-traffic-safety-analysis",
  ...
  },
  {
    ...
    openFirst: [
      ...
      },
      {
        title: "DecisionOps Lab",
        href: "/projects/decisionops-lab",
        reason: "제품 지표와 A/B evidence를 guardrail decision memo로 정리",
      },
      {
        title: "Starbucks",
