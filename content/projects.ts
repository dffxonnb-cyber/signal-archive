...
export const projects: Project[] = [
  {
    ...
    supportingLine:
      "데이터가 부족한 신도시에도 설치 우선순위를 설명 가능하게 만든 교통안전 분석",
    focusPoints: [
  ...
  },
  {
    ...
    supportingLine:
      "좋은 매물을 추천하기보다 먼저 보류해야 할 이유를 보여주는 상권 리스크 서비스",
    focusPoints: [
  ...
  },
  {
    ...
    supportingLine:
      "누구를 먼저 관리해야 하는가를 세그먼트가 아니라 예산 우선순위 문제로 번역한 CRM 분석",
    focusPoints: [
  ...
  },
  {
    ...
    supportingLine:
      "어떤 고객에게 어떤 오퍼를 어떤 채널로 보낼지 결정하게 만든 CRM 프로젝트",
    focusPoints: [
  ...
  },
  {
    ...
    supportingLine:
      "승리 요인, 선수 성과, 플레이 스타일을 하나의 분석 파이프라인으로 연결한 스포츠 분석",
    focusPoints: [
