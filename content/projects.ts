...
export const projects: Project[] = [
  {
    ...
    category: "대표 프로젝트",
    primaryDomain: "공공데이터",
    summary: "사고 건수 합계보다, 신도시에도 적용 가능한 설치 우선순위 기준을 세우는 교통안전 분석",
  ...
  },
  {
    ...
    category: "대표 프로젝트",
    primaryDomain: "공공데이터",
    summary: "좋아 보이는 매물 추천보다, 먼저 보류 사유를 구조적으로 드러내는 상권 리스크 분석",
  ...
  },
  {
    ...
    category: "대표 프로젝트",
    primaryDomain: "커머스",
    summary: "고객 분류보다, 누구를 먼저 관리할지 우선순위 해석으로 번역한 CRM 분석",
  ...
  },
  {
    ...
    summary: "반정형 이벤트 로그를 고객-오퍼-채널 구조로 재구성한 프로모션 의사결정 분석",
  ...
  },
  {
    ...
    category: "서브 프로젝트",
    primaryDomain: "스포츠",
    summary: "승리 요인, 선수 성과, 플레이 스타일을 하나의 예측 파이프라인으로 엮은 스포츠 분석",
    period: "Side analysis",
    format: "개인 프로젝트",
