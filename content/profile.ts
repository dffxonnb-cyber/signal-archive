...
export const profile: Profile = {
  ...
  avoidSignals: [],
  headline:
    "Python/SQL 기반 데이터 분석을 중심으로 웹앱, 서버리스 API, 자동화 검증까지 연결하는 데이터 프로덕트형 프로젝트를 구축합니다.",
  summary: [
    "공공데이터, 상권 데이터, CRM 데이터처럼 성격이 다른 데이터를 목적에 맞는 분석 단위와 지표로 다시 정리하고, 사용자가 읽을 수 있는 웹 결과물로 연결하는 작업을 강점으로 삼고 있습니다.",
