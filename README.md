...
| **DecisionOps Lab** | 데이터팀은 실험 결과를 어떻게 Ship / Retest / Hold / Investigate로 판단할 것인가? | SQL modeling, quality checks, A/B test evidence, multi-guardrail review, public reviewer report | [Detail](https://signal-archive.vercel.app/projects/decisionops-lab) · [Report](https://dffxonnb-cyber.github.io/DecisionOps-lab/) · [Repo](https://github.com/dffxonnb-cyber/DecisionOps-lab) |
